...
public interface StudentsApi {
    ...
    default ResponseEntity<Long> _postStudent(@ApiParam(value = "Description" ,required=true )  @Valid @RequestBody StudentDto student) {
    ...
    default ResponseEntity<Void> _putStudent(@ApiParam(value = "Description",required=true) @PathVariable("studentId") Long studentId,@ApiParam(value = "Description" ,required=true )  @Valid @RequestBody StudentDto student) {
